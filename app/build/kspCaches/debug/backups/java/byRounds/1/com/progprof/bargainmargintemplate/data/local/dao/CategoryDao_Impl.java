...
public final class CategoryDao_Impl implements CategoryDao {
  ...
  public CategoryDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCategoryEntity = new EntityInsertionAdapter<CategoryEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `categories` (`id`,`categoryName`,`totalBudget`,`budgetRemaining`) VALUES (nullif(?, 0),?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindDouble(4, entity.getBudgetRemaining());
      }
    };
    ...
    this.__updateAdapterOfCategoryEntity = new EntityDeletionOrUpdateAdapter<CategoryEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `categories` SET `id` = ?,`categoryName` = ?,`totalBudget` = ?,`budgetRemaining` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object deleteCategory(final CategoryEntity categoryEntity,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object updateCategory(final CategoryEntity categoryEntity,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"categories"}, new Callable<List<CategoryEntity>>() {
      ...
      public List<CategoryEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfBudgetRemaining = CursorUtil.getColumnIndexOrThrow(_cursor, "budgetRemaining");
          ...
          while (_cursor.moveToNext()) {
            ...
            final double _tmpBudgetRemaining;
            _tmpBudgetRemaining = _cursor.getDouble(_cursorIndexOfBudgetRemaining);
            _item = new CategoryEntity(_tmpId,_tmpCategoryName,_tmpTotalBudget,_tmpBudgetRemaining);
            _result.add(_item);
          }
          return _result;
        } finally {
